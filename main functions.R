...
#and adjusted projection-posterior credible intervals, along with a frequentist confidence 
#interval at a desired target coverage level (default is 0.95)
...
# the unadjusted and adjusted projection-posterior credible intervals, along with a 
# frequentist confidence interval at a desired target coverage level (default is 0.95)
...
############## estimation of monotone regression function on (0,1) #########
...
############ hypothesis testing for monotonicity in regression function #############
